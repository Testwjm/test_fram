...
class TestStrategyBlModel(MyTest):
    ...
    def test_strategy_bl_case3(self):
        """目标设定"""
        strategy = StrategyBlModel(self.driver)
        # 断言，目标设定
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[3]/div[2]/div[2]/span').text
        try:
        ...
        # 断言，目标函数选择
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[3]/div[3]/div[1]/span').text
        try:
        ...
        # 断言，选择约束条件
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[3]/div[4]/div[1]/span').text
        try:
        ...
        # 断言，指数名称
        error_mes = strategy.find_element(
            'xpath=>//*[@id="mvTb2"]/tbody/tr[1]/td[2]').text
        try:
        ...
        # 断言，区间年化收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="mvTb2"]/tbody/tr[1]/td[3]').text
        try:
            assert error_mes != u'--'
            print('区间年化收益率 pass')
        except Exception as e:
        ...
        # 断言，区间最大回撤
        error_mes = strategy.find_element(
            'xpath=>//*[@id="mvTb2"]/tbody/tr[1]/td[4]').text
        try:
            assert error_mes != u'--'
            print('区间最大回撤 pass')
        except Exception as e:
        ...
        # 断言，区间年化夏普比
        error_mes = strategy.find_element(
            'xpath=>//*[@id="mvTb2"]/tbody/tr[1]/td[5]').text
        try:
            assert error_mes != u'--'
            print('区间年化夏普比 pass')
        except Exception as e:
        ...
        # 断言，区间年化波动率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="mvTb2"]/tbody/tr[1]/td[6]').text
        try:
            ...
            print(error_mes)
        time.sleep(2)
        strategy.strategy_bl_target()

    def test_strategy_bl_case4(self):
        """策略组合"""
        strategy = StrategyBlModel(self.driver)
        # 断言，Benchmark
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[2]/table/tbody/tr/td[1]/div[2]').text
        try:
        ...
        # 断言，配置模式
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[2]/table/tbody/tr/td[2]/div[2]').text
        try:
            assert error_mes == u'BL模型'
            print('配置模式 pass')
        except Exception as e:
        ...
        # 断言，内外样本区间
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[2]/table/tbody/tr/td[3]/div[2]').text
        try:
            assert error_mes != u'--'
            print('内外样本区间 pass')
        except Exception as e:
        ...
        # 断言，目标既定
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[2]/table/tbody/tr/td[4]/div[2]').text
        try:
            assert error_mes == u'预期年化夏普比最大'
            print('目标既定 pass')
        except Exception as e:
        ...
        # 断言，全样本区间约束条件
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[2]/table/tbody/tr/td[5]/div[2]').text
        try:
            assert error_mes == u'预期年化收益率 >= 2%,预期年化波动率 <= 3%,预期无风险收益率=5%'
        ...
        # 断言，指数名称
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[1]').text
        try:
            assert error_mes == u'私募全市场指数'
            print('指数名称 pass')
        except Exception as e:
        ...
        # 断言，区间最大回撤
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[2]').text
        try:
            assert error_mes != u'--'
            print('区间最大回撤 pass')
        except Exception as e:
        ...
        # 断言，区间年化收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[3]').text
        try:
            assert error_mes != u'--'
            print('区间年化收益率 pass')
        except Exception as e:
        ...
        # 断言，区间年化夏普比
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[4]').text
        try:
            assert error_mes != u'--'
            print('区间年化夏普比 pass')
        except Exception as e:
        ...
        # 断言，区间年化波动率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[5]').text
        try:
            assert error_mes != u'--'
            print('区间年化波动率 pass')
        except Exception as e:
        ...
        # 断言，拟投资金额（万元）
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[6]').text
        try:
            assert error_mes != u'--'
            print('拟投资金额（万元） pass')
        except Exception as e:
        ...
        # 断言，拟投资比例
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blcreatPrctbl"]/tbody/tr[1]/td[7]').text
        try:
            assert error_mes != u'--'
            print('拟投资比例 pass')
        except Exception as e:
            print('拟投资比例 fail', format(e))
            print(error_mes)
        time.sleep(2)
        # 断言，有效边界
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[4]/div[1]/div[1]/div/span').text
        try:
        ...
        # 断言，组合回撤业绩指标
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/div/div/span').text
        try:
            assert error_mes == u'组合回撤业绩指标'
            print('组合回撤业绩指标 pass')
        except Exception as e:
            print('组合回撤业绩指标 fail', format(e))
            print(error_mes)
        time.sleep(2)
        # 断言，累计收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[1]/td[1]/div[2]').text
        try:
            assert error_mes != u'--'
            print('累计收益率 pass')
        except Exception as e:
        ...
        # 断言，年化收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[1]/td[2]/div[2]').text
        try:
            assert error_mes != u'--'
            print('年化收益率 pass')
        except Exception as e:
        ...
        # 断言，年化波动率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[1]/td[3]/div[2]').text
        try:
            assert error_mes != u'--'
            print('年化波动率 pass')
        except Exception as e:
        ...
        # 断言，年化下行标准差
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[2]/td[1]/div[2]').text
        try:
            assert error_mes != u'--'
            print('年化下行标准差 pass')
        except Exception as e:
        ...
        # 断言，Sortino比率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[2]/td[2]/div[2]').text
        try:
            assert error_mes != u'--'
        ...
        # 断言，年化夏普比
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[2]/td[3]/div[2]').text
        try:
            assert error_mes != u'--'
            print('年化夏普比 pass')
        except Exception as e:
        ...
        # 断言，最大回撤
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[3]/td[1]/div[2]').text
        try:
            assert error_mes != u'--'
            print('最大回撤 pass')
        except Exception as e:
        ...
        # 断言，最大回撤发生时间
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[3]/td[2]/div[2]').text
        try:
            assert error_mes != u'--'
            print('最大回撤发生时间 pass')
        except Exception as e:
        ...
        # 断言，最大回撤形成期
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blTbldiv"]/table/tbody/tr[3]/td[3]/div[2]').text
        try:
            assert error_mes != u'--'
            print('最大回撤形成期 pass')
        except Exception as e:
        ...
        # 断言，累计收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[5]/div/div[1]/div/span').text
        try:
        ...
        # 断言，期间收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[6]/div/div[1]/div/span').text
        try:
        ...
        # 断言，动态回撤
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[7]/div[1]/div/span').text
        try:
        ...
        # 断言，预期平均年化收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="createCompolicy"]/div/div/div[5]/div[2]/div[8]/div[1]/div/span').text
        try:
            assert error_mes == u'预期平均年化收益率'
            print('预期平均年化收益率 pass')
        except Exception as e:
            print('预期平均年化收益率 fail', format(e))
            print(error_mes)
        time.sleep(2)
        # 断言，投资时间
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blsecontTab"]/tbody/tr/td[1]').text
        try:
            assert error_mes != u'--'
            print('投资时间 pass')
        except Exception as e:
            print('投资时间 fail', format(e))
            print(error_mes)
        time.sleep(2)
        # 断言，预期收益
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blsecontTab"]/tbody/tr/td[2]').text
        try:
            assert error_mes != u'--'
            print('预期收益 pass')
        except Exception as e:
            print('预期收益 fail', format(e))
            print(error_mes)
        time.sleep(2)
        # 断言，70%概率收益波动区间
        error_mes = strategy.find_element(
            'xpath=>//*[@id="blsecontTab"]/tbody/tr/td[3]').text
        try:
            assert error_mes != u'--'
            print('70%概率收益波动区间 pass')
        except Exception as e:
            print('70%概率收益波动区间 fail', format(e))
            print(error_mes)
        time.sleep(2)
        strategy.execute_script_down()
        time.sleep(2)
        strategy.strategy_bl_compose()

    def test_strategy_bl_case5(self):
        """头部"""
        strategy = StrategyBlModel(self.driver)
        strategy.strategy_bl_head()
        # 断言，投资策略
        error_mes = strategy.find_element(
    ...
    def test_strategy_bl_case6(self):
        """历史净值"""
        strategy = StrategyBlModel(self.driver)
        strategy.strategy_bl_history()
        # 断言，净值日期
        error_mes = strategy.find_element(
    ...
    def test_strategy_bl_case7(self):
        """指标"""
        strategy = StrategyBlModel(self.driver)
        strategy.strategy_bl_index()
        '''收益指标'''
        # 断言，统计区间
        error_mes = strategy.find_element(
    ...
    def test_strategy_bl_case8(self):
        """持仓分析"""
        strategy = StrategyBlModel(self.driver)
        strategy.execute_script_up()
        time.sleep(2)
        strategy.strategy_bl_position()
        '''策略配置'''
        # 断言，期初净资产
    ...
    def test_strategy_bl_case9(self):
        """净值归因"""
        strategy = StrategyBlModel(self.driver)
        strategy.execute_script_up()
        time.sleep(2)
        strategy.strategy_bl_attribution()
        # 断言，大类资产占比情况
    ...
    def test_strategy_bl_case91(self):
        """情景分析"""
        strategy = StrategyBlModel(self.driver)
        strategy.execute_script_up()
        time.sleep(2)
    ...
    def test_strategy_bl_case92(self):
        """删除"""
        strategy = StrategyBlModel(self.driver)
        strategy.strategy_bl_delete()
        # 断言，删除产品
        error_mes = strategy.find_element(
    ...
    def test_strategy_bl_case93(self):
        """指数"""
        strategy = StrategyBlModel(self.driver)
        strategy.strategy_bl_exponent()
        '''策略指数累计收益率'''
        # 断言，策略指数累计收益率
