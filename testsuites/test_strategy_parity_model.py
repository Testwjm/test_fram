import time
from pageobjects.strategy_parity_model import  StrategyParityModel
from testsuites.my_test import MyTest


class TestStrategyParityModel(MyTest):
    """策略组合-风险平价模型"""

    def test_strategy_parity_case1(self):
        """登录"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_login()

    def test_strategy_parity_case2(self):
        """创建新的策略组合"""
        strategy = StrategyParityModel(self.driver)
        # 断言，创建产品组合
        ...
        try:
            ...
            print(error_mes)
        time.sleep(2)
        strategy.strategy_parity_establish()

    def test_strategy_parity_case3(self):
        """目标设定"""
        strategy = StrategyParityModel(self.driver)
        # 断言，目标设定
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskModel"]/div[2]/div[2]/span').text
        try:
        ...
        # 断言，目标函数选择
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskModel"]/div[3]/div[1]/span').text
        try:
        ...
        # 断言，选择约束条件
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskModel"]/div[3]/div[2]/div[2]/span').text
        try:
        ...
        # 断言，指数名称
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskTbl"]/tbody/tr[1]/td[2]').text
        try:
        ...
        # 断言，区间年化收益率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskTbl"]/tbody/tr[1]/td[3]').text
        try:
            assert error_mes != u'--'
            print('区间年化收益率 pass')
        except Exception as e:
        ...
        # 断言，区间最大回撤
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskTbl"]/tbody/tr[1]/td[4]').text
        try:
            assert error_mes != u'--'
            print('区间最大回撤 pass')
        except Exception as e:
        ...
        # 断言，区间年化夏普比
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskTbl"]/tbody/tr[1]/td[5]').text
        try:
            assert error_mes != u'--'
            print('区间年化夏普比 pass')
        except Exception as e:
        ...
        # 断言，区间年化波动率
        error_mes = strategy.find_element(
            'xpath=>//*[@id="riskTbl"]/tbody/tr[1]/td[6]').text
        try:
            ...
            print(error_mes)
        time.sleep(2)
        strategy.strategy_parity_target()

    def test_strategy_parity_case4(self):
        """策略组合"""
        strategy = StrategyParityModel(self.driver)
        # 断言，Benchmark
        error_mes = strategy.find_element(
        ...
        try:
            assert error_mes == u'原始风险平价-年化波动率'
            print('目标设定 pass')
        except Exception as e:
            print('目标设定 fail', format(e))
            print(error_mes)
        ...
        try:
            assert error_mes == u'年化波动率<=2%,无风险收益率=5%'
        ...
        time.sleep(2)
        strategy.strategy_parity_compose()

    def test_strategy_parity_case5(self):
        """头部"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_head()
        # 断言，投资策略
        error_mes = strategy.find_element(
    ...
    def test_strategy_parity_case6(self):
        """历史净值"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_history()
        # 断言，净值日期
        error_mes = strategy.find_element(
    ...
    def test_strategy_parity_case7(self):
        """指标"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_index()
        '''收益指标'''
        # 断言，统计区间
        error_mes = strategy.find_element(
    ...
    def test_strategy_parity_case92(self):
        """删除"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_delete()
        # 断言，删除产品
        error_mes = strategy.find_element(
    ...
    def test_strategy_parity_case93(self):
        """指数"""
        strategy = StrategyParityModel(self.driver)
        strategy.strategy_parity_exponent()
        '''策略指数累计收益率'''
        # 断言，策略指数累计收益率
