...
class StrategyCustomModel(BasePage):
    """策略组合-自定义子策略权重"""
    ...
    custom_model = 'xpath=>//*[@id="ConfigModel"]/div[2]/div[5]/label'  # 自定义子策略权重
    ...
    sure = 'xpath=>//*[@id="createCompolicy"]/div/div/div[10]/div[3]/button[2]'  # 确定
    ...
    def strategy_custom_login(self):
        """登录"""
    ...
    def strategy_custom_establish(self):
        """创建新的策略组合"""
        ...
        time.sleep(2)
        self.click(self.custom_model)
        time.sleep(3)
        self.click(self.next_step)
        time.sleep(5)

    def strategy_custom_compose(self):
        """策略组合"""
        self.click(self.sure)
        time.sleep(15)

    def strategy_custom_head(self):
        """头部"""
        pass

    def strategy_custom_history(self):
        """历史净值"""
    ...
    def strategy_custom_index(self):
        """指标"""
        pass

    def strategy_custom_position(self):
        """持仓分析"""
        self.click(self.position_analysis)
        time.sleep(5)

    def strategy_custom_attribution(self):
        """净值归因"""
        self.click(self.nv_attribution)
        time.sleep(5)

    def strategy_custom_scene(self):
        """情景分析"""
        self.click(self.scenario_analysis)
        time.sleep(5)

    def strategy_custom_delete(self):
        """删除"""
        self.click(self.asset_allocation)
        time.sleep(3)
        self.click(self.strategy_combination)
    ...
    def strategy_custom_exponent(self):
        """指数"""
        pass
